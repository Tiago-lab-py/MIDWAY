    ...
    con.execute(
        ...
        WITH raw_base AS (
            SELECT
                ...
                REGEXP_REPLACE(TRIM(CAST(r.NUM_MOTIVO_TRAT_DIF_UCI_ULT_HIADMS AS VARCHAR)), '\.0+$', '') AS NUM_MOTIVO_TRAT_DIF_UCI_RAW,
        ...
        tratado AS (
            SELECT
                ...
                REGEXP_REPLACE(TRIM(CAST(t.NUM_MOTIVO_TRAT_DIF_UCI AS VARCHAR)), '\.0+$', '') AS NUM_MOTIVO_TRAT_DIF_UCI_TRAT,
