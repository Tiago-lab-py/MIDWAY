...
def main() -> None:
    ...
    st.markdown(
        ...
        - **10 Envio IQS**: registra ajustes manuais e gera CSV corrigido para carga no IQS.

        Destaques da 6.2.1: exportação IQS padronizada, análise DBGUO de reclamações
        por ocorrência, serviços ADMS, Envio IQS com ajuste manual e dicionários `data/input` versionados.
        """
    )
