...
def criar_gold_impacto_conjunto_dia(con):
...
def exportar_gold_impacto_conjunto_dia(con):
    ...
    caminho_csv = MARTS_DIR / f"Gold_Impacto_Conjunto_Dia_{ANOMES}_{TIMESTAMP_ARQ}.CSV"
    caminho_resumo = MARTS_DIR / f"Gold_Impacto_Conjunto_Dia_{ANOMES}_{TIMESTAMP_ARQ}_RESUMO.TXT"
